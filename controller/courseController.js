...
exports.createCourse = async (req, res) => {
  try {
    ...
    const instructions = typeof _instructions === "string" ? _instructions.split(",") : _instructions;
...
exports.showAllCourses = async (req, res) => {
  try {
    ...
    return res.status(200).json({
      success: true,
      message: "Data Of All The Courses",
      data: allCourses,
    })
    ...
    return res.status(400).json({
      success: false,
      message: "Not fetched the Course data",
    });
  }
}
...
exports.getAllCoursesDetails = async (req, res) => {
  try {
    ...
    if (!CourseDetails) {
      return res.status(404).json({
        success: false,
        message: `DATA NOT FOUND WITH {courseId}`,
      });
    }
...
exports.getFullCourseDetails = async (req, res) => {
  try {
    ...
    console.log("Course details found. Now checking progress.");
